import { Mutation, Args, Resolver, Query, Int } from "@nestjs/graphql";
import { User, UserSearchResult } from "./user.entity";
import { TUserCreate, UserService } from "./user.service";
...
export class UsersResolver {
    ...
    async createUser(
        ...
        @Args('address', { type: () => String }) address = '',
        @Args('description', { type: () => String }) description = '',
        @Args('imageUrl', { type: () => String }) imageUrl = '',
